 ...
 */
#ifndef QDRAV_RQUEUE_H
#define QDRAV_RQUEUE_H
...
/**
 * \ingroup qdrav
 * \brief Q-DRAV route request queue
 *
 * Since Q-DRAV is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
